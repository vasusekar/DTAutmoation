package com.qa.dt.util;
	...
	public Xls_Reader() {
			...
			this.path=System.getProperty("user.dir")+"\\src\\main\\resources\\com.qa.testdata\\TestData.xlsx";
			try {
				fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\resources\\com.qa.testdata\\TestData.xlsx");
